...
<div id="content" class="content-wrapper">
    <div class="container-fluid-custom p-0">
        ...
        <form action="${pageContext.request.contextPath}/add-lesson" method="post" class="p-4 bg-white rounded shadow-lg">
                ...
                <div class="col-md-6 border-end pe-4">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="lessonName" name="lessonName" class="form-control"
                               placeholder="Enter lesson name" required maxlength="200">
                    </div>
                ...
                <div class="col-12 pt-3 border-top">
                    <div class="d-flex justify-content-between">
                        ...
                        <a href="${pageContext.request.contextPath}/course-content" class="btn btn-outline-secondary">
                            <i class="fas fa-arrow-left"></i> Back to Course Content
                        </a>
...
<script>
    ...
    // Auto-update order index when chapter is selected
    function updateOrderIndex() {
        var chapterId = document.getElementById('chapterId').value;
        if (chapterId) {
            fetch('${pageContext.request.contextPath}/add-lesson?action=getNextOrder&chapterId=' + chapterId)
